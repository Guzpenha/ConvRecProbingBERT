...
class AbstractTrainer(metaclass=ABCMeta):
    ...
    def validate(self, epoch, accum_iter):
        ...
        with open(os.path.join(self.args.output_predictions_folder, 'config.json'), 'w') as f:
        ...
        df.to_csv(self.args.output_predictions_folder+"/predictions.csv", index=False)
